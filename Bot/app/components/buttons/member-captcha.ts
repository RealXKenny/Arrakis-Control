  ...
  async execute(interaction: ButtonInteraction): Promise<void> {
    ...
    const modal = new ModalBuilder()
      ...
      .addLabelComponents((label) =>
        label.setLabel(`Enter this code: ${code}`).setTextInputComponent(new TextInputBuilder().setCustomId("captcha-answer").setStyle(TextInputStyle.Short).setRequired(true)),
      );
