...
exports.ensureServerInfoPanel = ensureServerInfoPanel;
...
async function ensureServerInfoPanel(client, channelId) {
    ...
    const response = (0, componentFactory_1.createV2Response)(containers, [
        {
