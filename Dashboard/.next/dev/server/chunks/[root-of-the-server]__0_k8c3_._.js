...
"[project]/dashboard/app/api/auth/login/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!clientId) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Server misconfigured: Missing Client ID'
            }, {
                status: 500
            });
        }
        if (!redirectUri) {
            console.error('Missing DISCORD_REDIRECT_URI configuration in environment variables.');
            return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Server misconfigured: Missing Discord redirect URI'
            }, {
                status: 500
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(discordAuthUrl);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_k8c3_._.js.map