...
"[project]/dashboard/app/api/auth/logout/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        if (sessionId && /*TURBOPACK member replacement*/ __turbopack_context__.g.dashboardSessions) {
            /*TURBOPACK member replacement*/ __turbopack_context__.g.dashboardSessions.delete(sessionId);
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/', appUrl));
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20jx3nr._.js.map