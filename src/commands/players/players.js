...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
       ...
       * ─────────────────────────────────────────────
       *
       * Adjust these if your Dune API uses a
       * different property for the total count.
       */
      ...
      const getPlayerCount = (response, formatted) => {
        ...
        /*
         * Fall back to the number of lines returned
         * by the formatter.
         */
      ...
      const errorCard = new ContainerBuilder()
        ...
        .addTextDisplayComponents((text) => text.setContent(`-# ${process.env.SERVER_NAME || "Dune: Awakening Community Server"}`))
